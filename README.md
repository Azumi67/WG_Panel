...
- مدیریت peers در پنل که شامل edit, reset time, reset usage, edit, template & short links, more information میشود
...
- امکان backup از طریق بات و ریستور ان از همان طریق
- فعلا برای نود نمایش لاگ و بک اپ گیری و ریستور ان تنها از طریق اسکریپت این امکان موجود است تا بعدا در پنل اضافه شود
...
-در صورت تمایل به تست و بررسی پنل، میتوانید مشکلاتی اگر در پنل دیدید در issue بیان کنید که برطرف بشود 
